const arrays = {
    title: "Arrays",
    description:
        "Arrays are like herds, groups of elements moving together. With arrays, you can collect, organize, and manipulate data with grace and speed. Let's learn how to gather and guide your own herds!",
    content: [
        {
...
const types = {
    title: "Types",
    description:
        "No, we aren’t an OOP language... not yet. But you can work with many different types. In this section, we'll explore some of them.",
    content: [
        {
            title: "Integers",
            data: [
...
const dicts = {
    title: "Dicts",
    description:
        "Sometimes, it's not enough to have just a list, you need names, maps, and meaning. Here dictionaries allow you to associate keys and values, creating powerful collections of knowledge. Let’s see how to build your own fields of wisdom.",
    content: [
        {
            title: "Creating a dict",
            data: [{ code: 'var dict << {"key": "value", "a": "vowel"};' }],
        },
        {
...
const functions = {
    title: "Functions",
    description:
        "In the world of Zumbra, functions are your magic spells. They let you define reusable actions, organize your code, and command the flow of your programs. It’s time to craft your own spells with fct.",
    content: [
        {
...
const inputAndOutput = {
    ...
    description:
        "Give Zumbra a voice (figuratively, of course) using show() and input().",
    content: [
        {
            title: "Using show",
            data: [
...
const conditionals = {
    title: "Conditionals",
    description:
        "In Zumbra, every journey is shaped by the choices you make. With if and else, you command your code to follow different paths, reacting to the conditions of the wild. Master conditionals to guide your programs through every fork in the road.",
    content: [
        {
            title: "The if",
            data: [
...
const loops = {
    title: "Loops",
    description:
        "Zumbra supports both `while` loops and collection iteration with `for ... in`.",
    content: [
        {
            title: "Using while",
            data: [
...
const messaging = {
    title: "Messaging",
    description:
        "Sometimes, your code needs to communicate with the outside world. With Zumbra, you can send emails or WhatsApp messages using simple built-in functions. Just configure them properly and you're ready to share your ideas.",
    content: [
        {
            title: "Send an Email",
            data: [
...
const math = {
    title: "Math",
    description:
        "Math is the language of logic, precision, and the universe. Zumbra brings math to your fingertips with simple and powerful tools. Let's explore how to solve equations and work with numbers!",
    content: [
        {
...
const http = {
    title: "HTTP",
    description:
        "Zumbra can consume APIs, serve static files, render HTML, and define REST endpoints.",
    content: [
        {
        ...
        },
        {
            ...
            data: [
                {
                    code: "restPost(\"/echo\", async fct(req, res) {\n    var body << await req.body;\n\n    res.status(201);\n    res.json({\n        \"ok\": true,\n        \"body\": body\n    });\n});\n\nserver(3333);",
                },
                {
                    text: "HTTP handlers can also be async, which is useful for request body parsing and async integrations.",
                },
            ],
        }
    ],
...
const strings = {
    title: "Strings",
    description:
        "Strings are the voice of your code, carrying messages, labels, and even poetry. With Zumbra, you can easily transform, clean, and format strings to fit your needs. Let's explore how to work with text!",
    content: [
        {
...
const build = {
    ...
    description:
        "Ok, you ended your zumbra app, now you want to deploy it? Here's how you can build a zumbra app :",
    content: [
        {
...
const mysqlExamples = {
    title: "MySQL",
    description:
        "With Zumbra, you can connect to MySQL databases and perform operations like creating tables, inserting records, updating, deleting, and selecting data, all with simple built-in functions.",
    content: [
        {
...
const switchCaseExamples = {
    title: "Switch Case",
    description:
        "Use `switchCase(value, cases, defaultValue)` to map values to results in a clean way.",
    content: [
        {
...
const supabaseExamples = {
    title: "Supabase",
    description:
        "Zumbra includes helpers for Supabase database, storage, auth, and RPC operations.",
    content: [
        {
...
const asyncExamples = {
    ...
    description:
        "Zumbra supports asynchronous functions with `async fct` and async resolution with `await`.",
    content: [
        {
            title: "Create an async function",
            data: [
                {
                    code: "var add << async fct(a, b) {\n    return a + b;\n};\n\nvar result << await add(10, 20);\nshow(result);",
                },
                {
                    text: "Use `async fct(...)` to declare asynchronous functions and `await` to resolve the result.",
                },
            ],
        },
        {
            title: "Await inside another async function",
            data: [
                {
                    code: "var getBase << async fct() {\n    return 10;\n};\n\nvar calculate << async fct() {\n    var base << await getBase();\n    return base * 5;\n};\n\nshow(await calculate());",
                },
                {
                    text: "You can chain async functions and await intermediate values inside other async functions.",
                },
            ],
        },
        {
            title: "Basic await usage",
            data: [
                {
                    code: "var getValue << async fct() {\n    return 42;\n};\n\nvar value << await getValue();\nshow(value);",
                },
            ],
        },
    ],
...
const errorHandlingExamples = {
    ...
    description:
        "Zumbra supports guarded async execution with `try await`, fallback handling with `or`, and captured errors with `or err`.",
    content: [
        {
            title: "Use try await",
            data: [
                {
                    code: "var getUser << async fct() {\n    return {\n        \"id\": 1,\n        \"name\": \"Lucas\"\n    };\n};\n\nvar user << try await getUser();\nshow(user.name);",
                },
                {
                    text: "Use `try await` when awaiting operations that may fail.",
                },
            ],
        },
        {
            title: "Handle fallback with or",
            data: [
                {
                    code: "restGet(\"/fail\", async fct(req, res) {\n    var result << error(\"boom\") or {\n        res.status(400);\n        res.json({\n            \"ok\": false,\n            \"handled\": true,\n            \"message\": \"error handler worked\"\n        });\n        return;\n    };\n\n    res.json({\n        \"ok\": true,\n        \"result\": result\n    });\n});",
                },
                {
                    text: "Use `or { ... }` to define a fallback block when an operation fails.",
                },
            ],
        },
        {
            title: "Capture the error with or err",
            data: [
                {
                    code: "var inserted << supabaseInsert(\"admins\", {\n    \"name\": req.body.name,\n    \"email\": req.body.email\n}) or err {\n    res.status(500);\n    res.json({\n        \"created\": false,\n        \"error\": true,\n        \"message\": err.message,\n    });\n    return;\n};",
                },
                {
                    text: "Use `or err { ... }` when you want access to the captured error object.",
                },
            ],
        },
    ],
